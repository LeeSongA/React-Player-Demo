            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <button onClick={this.handleSetPlaybackRate} value={3.5}>3.5x</button>
                  <button onClick={this.handleSetPlaybackRate} value={4}>4x</button>
                  <button onClick={this.handleSetPlaybackRate} value={4.5}>4.5x</button>
                  <button onClick={this.handleSetPlaybackRate} value={5}>5x</button>
                  <button onClick={this.handleSetPlaybackRate} value={5.5}>5.5x</button>
